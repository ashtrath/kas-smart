...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filament-logger.datetime_format' => 'string',
            'filament-logger.date_format' => 'string',
            'filament-logger.activity_resource' => 'string',
            'filament-logger.scoped_to_tenant' => 'boolean',
            'filament-logger.navigation_sort' => 'NULL',
            'filament-logger.resources.enabled' => 'boolean',
            'filament-logger.resources.log_name' => 'string',
            'filament-logger.resources.logger' => 'string',
            'filament-logger.resources.color' => 'string',
            'filament-logger.resources.exclude' => 'array',
            'filament-logger.resources.cluster' => 'NULL',
            'filament-logger.resources.navigation_group' => 'string',
            'filament-logger.access.enabled' => 'boolean',
            'filament-logger.access.logger' => 'string',
            'filament-logger.access.color' => 'string',
            'filament-logger.access.log_name' => 'string',
            'filament-logger.notifications.enabled' => 'boolean',
            'filament-logger.notifications.logger' => 'string',
            'filament-logger.notifications.color' => 'NULL',
            'filament-logger.notifications.log_name' => 'string',
            'filament-logger.models.enabled' => 'boolean',
            'filament-logger.models.log_name' => 'string',
            'filament-logger.models.color' => 'string',
            'filament-logger.models.logger' => 'string',
            'filament-logger.models.register' => 'array',
            'filament-logger.custom' => 'array',
            ...
            'filesystems.links.C:\Users\Ashtrath\Project\kas-smart\public\storage' => 'string',
            ...
            'settings.database_table_name' => 'string',
            'settings.cache_key' => 'string',
            'themes.mode' => 'string',
            'themes.icon' => 'string',
            'themes.default.theme' => 'string',
            'themes.default.theme_color' => 'string',
...
'filament-logger.datetime_format','filament-logger.date_format','filament-logger.activity_resource','filament-logger.scoped_to_tenant','filament-logger.navigation_sort',
'filament-logger.resources.enabled','filament-logger.resources.log_name','filament-logger.resources.logger','filament-logger.resources.color','filament-logger.resources.exclude',
'filament-logger.resources.cluster','filament-logger.resources.navigation_group','filament-logger.access.enabled','filament-logger.access.logger','filament-logger.access.color',
'filament-logger.access.log_name','filament-logger.notifications.enabled','filament-logger.notifications.logger','filament-logger.notifications.color','filament-logger.notifications.log_name',
'filament-logger.models.enabled','filament-logger.models.log_name','filament-logger.models.color','filament-logger.models.logger','filament-logger.models.register',
'filament-logger.custom','filament-shield.shield_resource.should_register_navigation','filament-shield.shield_resource.slug','filament-shield.shield_resource.navigation_sort','filament-shield.shield_resource.navigation_badge',
'filament-shield.shield_resource.navigation_group','filament-shield.shield_resource.is_globally_searchable','filament-shield.shield_resource.show_model_path','filament-shield.shield_resource.is_scoped_to_tenant','filament-shield.shield_resource.cluster',
'filament-shield.tenant_model','filament-shield.auth_provider_model.fqcn','filament-shield.super_admin.enabled','filament-shield.super_admin.name','filament-shield.super_admin.define_via_gate',
'filament-shield.super_admin.intercept_gate','filament-shield.panel_user.enabled','filament-shield.panel_user.name','filament-shield.permission_prefixes.resource','filament-shield.permission_prefixes.page',
'filament-shield.permission_prefixes.widget','filament-shield.entities.pages','filament-shield.entities.widgets','filament-shield.entities.resources','filament-shield.entities.custom_permissions',
'filament-shield.generator.option','filament-shield.generator.policy_directory','filament-shield.generator.policy_namespace','filament-shield.exclude.enabled','filament-shield.exclude.pages',
'filament-shield.exclude.widgets','filament-shield.exclude.resources','filament-shield.discovery.discover_all_resources','filament-shield.discovery.discover_all_widgets','filament-shield.discovery.discover_all_pages',
'filament-shield.register_role_policy.enabled','filesystems.default','filesystems.disks.local.driver','filesystems.disks.local.root','filesystems.disks.local.serve',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.C:\\Users\\Ashtrath\\Project\\kas-smart\\public\\storage','logging.default',
...
'settings.database_table_name','settings.cache_key','themes.mode','themes.icon','themes.default.theme',
'themes.default.theme_color','broadcasting.default','broadcasting.connections.reverb.driver','broadcasting.connections.reverb.key','broadcasting.connections.reverb.secret',
...
'filament.admin.pages.dashboard','filament.admin.pages.settings','filament.admin.pages.my-profile','filament.admin.pages.themes','filament.admin.resources.activity-logs.index',
'filament.admin.resources.activity-logs.view','filament.admin.resources.users.index','filament.admin.resources.users.create','filament.admin.resources.users.edit','filament.admin.resources.shield.roles.index',
'filament.admin.resources.shield.roles.create','filament.admin.resources.shield.roles.view','filament.admin.resources.shield.roles.edit','filament.admin.auth.two-factor','livewire.update','livewire.upload-file','livewire.preview-file',
'storage.local',);
...
'filament-auth-ui-enhancer::custom-auth-layout','filament-breezy::components.clipboard-link','filament-breezy::components.grid-section','filament-breezy::filament.pages.my-profile','filament-breezy::filament.pages.two-factor',
...
'filament-panels::resources.relation-manager','filament-panels::widgets.account-widget','filament-panels::widgets.filament-info-widget','filament-settings::filament.pages.settings','filament-shield::forms.shield-toggle',
...
'pagination::simple-bootstrap-5','pagination::simple-default','pagination::simple-tailwind','pagination::tailwind','themes::filament.hooks.tenant-menu',
'themes::filament.pages.themes','themes::filament.pages.themes-footer',);
...
'validation.uuid','validation.custom.attribute-name.rule-name','translations.0','filament-shield.0','filament-shield::filament-shield.column.name',
...
'filament-tables::table.sorting.fields.direction.options.desc','themes::themes.themes','themes::themes.primary_color','themes::themes.select_base_color','themes::themes.custom',
'themes::themes.no_changing_primary_color','themes::themes.support_changing_primary_color','themes::themes.select_interface','themes::themes.select','themes::themes.light',
'themes::themes.dark','themes::themes.active','themes::themes.primary_color_set','themes::themes.theme_set_to','themes::themes.appearance',
'themes::themes.no_light_mode','themes::themes.no_dark_mode','themes::themes.support_light_mode','themes::themes.support_dark_mode','themes::themes.theme_active',
'filament-breezy::default.password_confirm.heading','filament-breezy::default.password_confirm.description','filament-breezy::default.password_confirm.current_password','filament-breezy::default.two_factor.heading','filament-breezy::default.two_factor.description',
'filament-breezy::default.two_factor.code_placeholder','filament-breezy::default.two_factor.recovery.heading','filament-breezy::default.two_factor.recovery.description','filament-breezy::default.two_factor.recovery_code_placeholder','filament-breezy::default.two_factor.recovery_code_text',
'filament-breezy::default.two_factor.recovery_code_link','filament-breezy::default.two_factor.back_to_login_link','filament-breezy::default.profile.account','filament-breezy::default.profile.profile','filament-breezy::default.profile.my_profile',
'filament-breezy::default.profile.subheading','filament-breezy::default.profile.personal_info.heading','filament-breezy::default.profile.personal_info.subheading','filament-breezy::default.profile.personal_info.submit.label','filament-breezy::default.profile.personal_info.notify',
'filament-breezy::default.profile.password.heading','filament-breezy::default.profile.password.subheading','filament-breezy::default.profile.password.submit.label','filament-breezy::default.profile.password.notify','filament-breezy::default.profile.2fa.title',
'filament-breezy::default.profile.2fa.description','filament-breezy::default.profile.2fa.actions.enable','filament-breezy::default.profile.2fa.actions.regenerate_codes','filament-breezy::default.profile.2fa.actions.disable','filament-breezy::default.profile.2fa.actions.confirm_finish',
'filament-breezy::default.profile.2fa.actions.cancel_setup','filament-breezy::default.profile.2fa.setup_key','filament-breezy::default.profile.2fa.must_enable','filament-breezy::default.profile.2fa.not_enabled.title','filament-breezy::default.profile.2fa.not_enabled.description',
'filament-breezy::default.profile.2fa.finish_enabling.title','filament-breezy::default.profile.2fa.finish_enabling.description','filament-breezy::default.profile.2fa.enabled.notify','filament-breezy::default.profile.2fa.enabled.title','filament-breezy::default.profile.2fa.enabled.description',
'filament-breezy::default.profile.2fa.enabled.store_codes','filament-breezy::default.profile.2fa.disabling.notify','filament-breezy::default.profile.2fa.regenerate_codes.notify','filament-breezy::default.profile.2fa.confirmation.success_notification','filament-breezy::default.profile.2fa.confirmation.invalid_code',
'filament-breezy::default.profile.sanctum.title','filament-breezy::default.profile.sanctum.description','filament-breezy::default.profile.sanctum.create.notify','filament-breezy::default.profile.sanctum.create.message','filament-breezy::default.profile.sanctum.create.submit.label',
'filament-breezy::default.profile.sanctum.update.notify','filament-breezy::default.profile.sanctum.update.submit.label','filament-breezy::default.profile.sanctum.copied.label','filament-breezy::default.clipboard.link','filament-breezy::default.clipboard.tooltip',
'filament-breezy::default.fields.avatar','filament-breezy::default.fields.email','filament-breezy::default.fields.login','filament-breezy::default.fields.name','filament-breezy::default.fields.password',
'filament-breezy::default.fields.password_confirm','filament-breezy::default.fields.new_password','filament-breezy::default.fields.new_password_confirmation','filament-breezy::default.fields.token_name','filament-breezy::default.fields.token_expiry',
'filament-breezy::default.fields.abilities','filament-breezy::default.fields.2fa_code','filament-breezy::default.fields.2fa_recovery_code','filament-breezy::default.fields.created','filament-breezy::default.fields.expires',
'filament-breezy::default.or','filament-breezy::default.cancel','filament-settings::translations.form.actions.save','filament-settings::translations.page.title','filament-settings::translations.page.navigation_label',
'filament-settings::translations.notifications.saved','filament-logger::filament-logger.nav.group','filament-logger::filament-logger.nav.log.label','filament-logger::filament-logger.nav.log.icon','filament-logger::filament-logger.resource.label.log',
'filament-logger::filament-logger.resource.label.logs','filament-logger::filament-logger.resource.label.user','filament-logger::filament-logger.resource.label.subject','filament-logger::filament-logger.resource.label.subject_type','filament-logger::filament-logger.resource.label.description',
'filament-logger::filament-logger.resource.label.type','filament-logger::filament-logger.resource.label.event','filament-logger::filament-logger.resource.label.logged_at','filament-logger::filament-logger.resource.label.properties','filament-logger::filament-logger.resource.label.old',
'filament-logger::filament-logger.resource.label.new','filament-logger::filament-logger.resource.label.old_value','filament-logger::filament-logger.resource.label.new_value','filament-logger::filament-logger.resource.label.properties_hint','filament-logger::filament-logger.resource.label.old_attributes',
'filament-logger::filament-logger.resource.label.new_attributes',);
